      ...
      <nav class="bottom-navbar">
        <div class="container">
          <ul class="nav page-navigation">
            <li class="nav-item">
              <a class="nav-link" href="data_pembeli.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="daftar_pembeli.php">
                <i class="mdi mdi-file-document-box-outline menu-icon"></i>
                <span class="menu-title">Daftar Pembelian</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="daftar_reservasi.php">
                <i class="mdi mdi-file-document-box-outline menu-icon"></i>
                <span class="menu-title">Daftar Reservasi</span>
              </a>
            </li>
          </ul>
        </div>
